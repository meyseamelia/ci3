<?php
    class UserRoles_Model extends CI_Model{
        ...
        public function create() {
            ...
            if ($response->status == 200) {
                $this->session->set_flashdata('success', "<b>Respond Status:</b> $response->status;<br><b>Message:</b> $response->message");
                return true;
            }
            else {
                $this->session->set_flashdata('error', "<b>Respond Status:</b> $response->status;<br><b>Message:</b> $response->message");
                throw new Exception();            
            }
        }
